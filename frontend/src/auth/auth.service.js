...
export const register = async ({ registerData }) => {
  try {
    const response = await axiosInstance.post(API_BASE_URL + `register`, registerData);
...
//  console.log(
//    '🚀 Welcome to ProManage ERP CRM! Did you know that we also offer commercial customization services? Contact us at hello@promanage.com for more information.'
//  );
