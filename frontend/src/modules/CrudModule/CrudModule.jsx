...
function SidePanelTopContent({ config, formElements, withUpload }) {
  ...
  const updateManyItems = () => {
    // Logic to get selected items and dispatch updateMany action
    const selectedItems = []; // Replace with your logic to get selected items
    dispatch(crud.updateMany({ entity: config.entity, items: selectedItems }));
  };
